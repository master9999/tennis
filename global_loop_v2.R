...
query_text_win <- sprintf("SELECT TOP 5000 g.*,o.*,c.ID_C
...
query_text_loss <- sprintf("SELECT TOP 5000 g.*, o.*, c.ID_C
FROM games_atp g, odds_atp o, tours_atp t, courts c
where g.ID_T_G = o.ID_T_O
AND g.ID_R_G = o.ID_R_o
AND o.ID_B_O = 1
...
colnames(total_data) <- colnames(alldata)

close(mdbConnect)

#boxplot(alldata$simpleodds ~ alldata$win)	
#boxplot(alldata$percentage_won_90 ~ alldata$win)	
#boxplot(alldata$matches_opponents_90_days ~ alldata$win)	
# plot(alldata$simpleodds,alldata$percentage_won_player_90, col=as.factor(alldata$win))
#boxplot(as.numeric(alldata$percentage_won_player_90) ~ alldata$win)
# plot(alldata$simpleodds,as.numeric(alldata$percentage_won_player_30), col=as.factor(alldata$win))
#boxplot(alldata$sets_previous_match ~ alldata$win)
# plot(alldata$simpleodds,alldata$sets_previous_match , col=as.factor(alldata$win))
#boxplot(alldata$days_since_previous_match ~ alldata$win)
# plot(alldata$simpleodds,alldata$days_since_previous_match , col=as.factor(alldata$win))
#boxplot(alldata$percentage_player_won_30_vs_60 ~ alldata$win)
# plot(alldata$simpleodds,alldata$percentage_player_won_30_vs_60 , col=as.factor(alldata$win))
#boxplot(alldata$evolution_won_30_vs_60_player_vs_opponent ~ alldata$win)
# plot(alldata$simpleodds,alldata$evolution_won_60_vs_90_player_vs_opponent , col=as.factor(alldata$win))

# plot(alldata$simpleodds,alldata$ID_C , col=as.factor(alldata$win))
